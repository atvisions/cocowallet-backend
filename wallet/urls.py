...
from .views.tasks import TaskViewSet, ShareTaskViewSet, ShareTaskTokenViewSet
...
router.register(r'share-tasks', ShareTaskViewSet, basename='share-task')
router.register(r'share-task-tokens', ShareTaskTokenViewSet, basename='share-task-token')

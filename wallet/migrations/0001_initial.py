# Generated by Django 4.2.18 on 2025-03-27 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "daily_limit",
                    models.IntegerField(default=1, verbose_name="每日限制次数"),
                ),
                (
                    "is_repeatable",
                    models.BooleanField(default=False, verbose_name="是否可重复"),
                ),
                (
                    "is_active",
                ...
                (
                    "stages_config",
                    models.JSONField(blank=True, default=dict, verbose_name="阶段配置"),
                ),
                (
                    "created_at",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="share_token_tasks",
                to="wallet.task",
            ),
        ),
        migrations.AddField(
